...
import classes.proteinclass as proteinclass
...
if os.path.isfile('../models/gnn_model2.pth'):
    mlp_model.load_state_dict(torch.load('../models/gnn_model2.pth'))
...
for file in os.listdir(rootdir): # This will get all the proteins inside the scPDB folder
    ...
    torch.save(mlp_model.state_dict(), '../models/gnn_model2.pth')
